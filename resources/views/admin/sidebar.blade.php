        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{@route('admin.order.index',['slug'=>'Accepted'])}}"><i class="fa fa-circle-o"></i>Accepted Orders</a></li>
                    <li><a href="{{@route('admin.order.index',['slug'=>'Shipped'])}}"><i class="fa fa-circle-o"></i>Shipping Orders</a></li>
                    <li><a href="{{@route('admin.order.index',['slug'=>'Completed'])}}"><i class="fa fa-circle-o"></i>Completed Orders</a></li>
                    <li><a href="{{@route('admin.order.index',['slug'=>'Cancelled'])}}"><i class="fa fa-circle-o"></i>Cancelled Orders</a></li>
